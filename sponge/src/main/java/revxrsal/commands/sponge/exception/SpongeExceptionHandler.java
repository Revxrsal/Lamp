...
public class SpongeExceptionHandler extends DefaultExceptionHandler<SpongeCommandActor> {
    ...
    @Override
    public void onInvalidStringSize(@NotNull InvalidStringSizeException e, @NotNull SpongeCommandActor actor, @NotNull ParameterNode<SpongeCommandActor, ?> parameter) {
