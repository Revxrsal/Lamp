...
/**
 * Represents a command error, for example when an invalid value is returned, a condition is
 * violated, or an illegal value is inputted, and validated through a parameter validator.
 * <p>
 * This exception should be used to directly transfer error messages to the {@link CommandActor},
 * and is always used in command-fail contexts. For exceptions that only reply to the actor, see
 * {@link SendMessageException}.
 */
