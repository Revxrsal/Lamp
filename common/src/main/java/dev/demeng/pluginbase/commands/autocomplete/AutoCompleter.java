...
import dev.demeng.pluginbase.commands.annotation.AutoComplete;
...
public interface AutoCompleter {
  ...
  /**
   * Registers a {@link SuggestionProvider} for the specified ID, for use in commands through the
   ...
   */
  AutoCompleter registerSuggestion(@NotNull String providerID,
  ...
  /**
   * Registers a {@link SuggestionProvider} for a specific parameter type. This way, if the
   * parameter is requested in the command, it will automatically be tab-completed without having to
  ...
  /**
   * Registers a {@link SuggestionProviderFactory} that creates suggestion providers dynamically for
   * parameters. This allows for checking against custom annotations in parameters.
   *
  ...
  /**
   * Returns the containing {@link CommandHandler} of this auto completer. This will allow for
   * writing fluent and readable code.
   *
