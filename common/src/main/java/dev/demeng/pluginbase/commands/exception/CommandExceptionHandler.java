 ...
 * <p>
 * Exceptions may be anything, including Java's normal exceptions, and build-in ones thrown by
 * different components in the framework.
 * <p>
...
public interface CommandExceptionHandler {
  ...
  /**
   * Handles the given exception. Note that this method does not provide information about the
   * command context (such as the command, etc.) These are available in individual exceptions and
