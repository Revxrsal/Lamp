...
public interface LifecycleEventManager<O> {
     ...
     */
    default <E extends LifecycleEvent> void registerEventHandler(final @NotNull LifecycleEventType<?, ? extends E, ?> eventType, final @NotNull LifecycleEventHandler<? super E> eventHandler) {
     ...
     */
    void registerEventHandler(@NotNull LifecycleEventHandlerConfiguration<?> handlerConfiguration);
}
